...
if (footerText && currentYear > 2024) {
    footerText.textContent = `© ${currentYear} Nigina Bonu. All rights reserved.`;
}
...
console.log('%cIf you have any questions, feel free to reach out.', 'font-size: 14px; color: #64748b;');
